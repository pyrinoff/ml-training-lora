...
model.eval()
if torch.__version__ >= "2" and platform.system() != 'Windows':
...
if __name__ == "__main__":
    with open(EVAL_FILE, "rb") as json_file:
    ...
    filepath = EVAL_FOLDER + "/evaluation_" + BASE_MODEL.replace('/', '_') + '--' + LORA_WEIGHTS.replace('/', '_') + ".json"
